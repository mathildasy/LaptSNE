...
/* "sklearn/ensemble/_hist_gradient_boosting/_binning.pyx":16
 * 
 * 
...
static PyObject *__pyx_pw_7sklearn_8ensemble_23_hist_gradient_boosting_8_binning_1_map_to_bins(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("_map_to_bins (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_binning_thresholds)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("_map_to_bins", 1, 5, 5, 1); __PYX_ERR(0, 16, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_missing_values_bin_idx)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_map_to_bins", 1, 5, 5, 2); __PYX_ERR(0, 16, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_n_threads)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_map_to_bins", 1, 5, 5, 3); __PYX_ERR(0, 16, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_binned)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_map_to_bins", 1, 5, 5, 4); __PYX_ERR(0, 16, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "_map_to_bins") < 0)) __PYX_ERR(0, 16, __pyx_L3_error)
      }
    ...
    __pyx_v_data = __Pyx_PyObject_to_MemoryviewSlice_dsds_nn___pyx_t_7sklearn_8ensemble_23_hist_gradient_boosting_6common_X_DTYPE_C__const__(values[0], 0); if (unlikely(!__pyx_v_data.memview)) __PYX_ERR(0, 16, __pyx_L3_error)
    __pyx_v_binning_thresholds = ((PyObject*)values[1]);
    __pyx_v_missing_values_bin_idx = __Pyx_PyInt_As_unsigned_char(values[2]); if (unlikely((__pyx_v_missing_values_bin_idx == (unsigned char)-1) && PyErr_Occurred())) __PYX_ERR(0, 18, __pyx_L3_error)
    __pyx_v_n_threads = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_n_threads == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 19, __pyx_L3_error)
    __pyx_v_binned = __Pyx_PyObject_to_MemoryviewSlice_dcd__nn___pyx_t_7sklearn_8ensemble_23_hist_gradient_boosting_6common_X_BINNED_DTYPE_C(values[4], PyBUF_WRITABLE); if (unlikely(!__pyx_v_binned.memview)) __PYX_ERR(0, 20, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("_map_to_bins", 1, 5, 5, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 16, __pyx_L3_error)
  __pyx_L3_error:;
 ...
 */
    ...
    /* "sklearn/ensemble/_hist_gradient_boosting/_binning.pyx":46
 *                              missing_values_bin_idx,
 *                              n_threads,
 *                              binned[:, feature_idx])             # <<<<<<<<<<<<<<
 * 
...
/* "sklearn/ensemble/_hist_gradient_boosting/_binning.pyx":49
 * 
 * 
 ...
 */
                              while (1) {
                                ...
                                /* "sklearn/ensemble/_hist_gradient_boosting/_binning.pyx":70
 *             while left < right:
 *                 # equal to (right + left - 1) // 2 but avoids overflow
 *                 middle = left + (right - left - 1) // 2             # <<<<<<<<<<<<<<
 ...
 */
                                ...
                                /* "sklearn/ensemble/_hist_gradient_boosting/_binning.pyx":74
 *                     right = middle
 *                 else:
 *                     left = middle + 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
                              ...
                              /* "sklearn/ensemble/_hist_gradient_boosting/_binning.pyx":76
 *                     left = middle + 1
 * 
 *             binned[i] = left             # <<<<<<<<<<<<<<
 */
 ...
 *                  const unsigned char missing_values_bin_idx,
 */
  __pyx_tuple__21 = PyTuple_Pack(6, __pyx_n_s_data, __pyx_n_s_binning_thresholds, __pyx_n_s_missing_values_bin_idx, __pyx_n_s_n_threads, __pyx_n_s_binned, __pyx_n_s_feature_idx); if (unlikely(!__pyx_tuple__21)) __PYX_ERR(0, 16, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__21);
  __Pyx_GIVEREF(__pyx_tuple__21);
  __pyx_codeobj__22 = (PyObject*)__Pyx_PyCode_New(5, 0, 6, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__21, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_sklearn_ensemble__hist_gradient, __pyx_n_s_map_to_bins, 16, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__22)) __PYX_ERR(0, 16, __pyx_L1_error)
...
if (!__Pyx_RefNanny) {
  ...
  /* "sklearn/ensemble/_hist_gradient_boosting/_binning.pyx":5
 * cimport cython
 * 
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 ...
 */
  ...
  /* "sklearn/ensemble/_hist_gradient_boosting/_binning.pyx":13
 ...
 *                  const unsigned char missing_values_bin_idx,
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_7sklearn_8ensemble_23_hist_gradient_boosting_8_binning_1_map_to_bins, NULL, __pyx_n_s_sklearn_ensemble__hist_gradient_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 16, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_map_to_bins, __pyx_t_1) < 0) __PYX_ERR(0, 16, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
