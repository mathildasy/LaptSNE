 ...
 *                                       X_DTYPE_C[:] categories):
 */
  __pyx_tuple__21 = PyTuple_Pack(5, __pyx_n_s_raw_bitset, __pyx_n_s_binned_bitset, __pyx_n_s_categories, __pyx_n_s_binned_cat_value, __pyx_n_s_raw_cat_value); if (unlikely(!__pyx_tuple__21)) __PYX_ERR(0, 52, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__21);
  __Pyx_GIVEREF(__pyx_tuple__21);
  __pyx_codeobj__22 = (PyObject*)__Pyx_PyCode_New(3, 0, 5, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__21, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_sklearn_ensemble__hist_gradient, __pyx_n_s_set_raw_bitset_from_binned_bitse, 52, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__22)) __PYX_ERR(0, 52, __pyx_L1_error)
