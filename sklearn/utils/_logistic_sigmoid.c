...
static PyObject *__pyx_pw_7sklearn_5utils_17_logistic_sigmoid_1_log_logistic_sigmoid(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("_log_logistic_sigmoid (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_n_features)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("_log_logistic_sigmoid", 1, 4, 4, 1); __PYX_ERR(0, 18, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_X)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_log_logistic_sigmoid", 1, 4, 4, 2); __PYX_ERR(0, 18, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_out)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_log_logistic_sigmoid", 1, 4, 4, 3); __PYX_ERR(0, 18, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "_log_logistic_sigmoid") < 0)) __PYX_ERR(0, 18, __pyx_L3_error)
      }
    ...
    __pyx_v_n_samples = __Pyx_PyInt_As_unsigned_int(values[0]); if (unlikely((__pyx_v_n_samples == (unsigned int)-1) && PyErr_Occurred())) __PYX_ERR(0, 18, __pyx_L3_error)
    __pyx_v_n_features = __Pyx_PyInt_As_unsigned_int(values[1]); if (unlikely((__pyx_v_n_features == (unsigned int)-1) && PyErr_Occurred())) __PYX_ERR(0, 19, __pyx_L3_error)
    __pyx_v_X = __Pyx_PyObject_to_MemoryviewSlice_dsds_nn___pyx_t_7sklearn_5utils_17_logistic_sigmoid_DTYPE_t(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_X.memview)) __PYX_ERR(0, 20, __pyx_L3_error)
    __pyx_v_out = __Pyx_PyObject_to_MemoryviewSlice_dsds_nn___pyx_t_7sklearn_5utils_17_logistic_sigmoid_DTYPE_t(values[3], PyBUF_WRITABLE); if (unlikely(!__pyx_v_out.memview)) __PYX_ERR(0, 21, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("_log_logistic_sigmoid", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 18, __pyx_L3_error)
  __pyx_L3_error:;
 ...
 */
  ...
  __pyx_t_11 = __pyx_memoryview_fromslice(__pyx_v_out, 2, (PyObject *(*)(char *)) __pyx_memview_get_nn___pyx_t_7sklearn_5utils_17_logistic_sigmoid_DTYPE_t, (int (*)(char *, PyObject *)) __pyx_memview_set_nn___pyx_t_7sklearn_5utils_17_logistic_sigmoid_DTYPE_t, 0);; if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 29, __pyx_L1_error)
 ...
 *                           DTYPE_t[:, :] X,
 */
  __pyx_tuple__21 = PyTuple_Pack(6, __pyx_n_s_n_samples, __pyx_n_s_n_features, __pyx_n_s_X, __pyx_n_s_out, __pyx_n_s_i, __pyx_n_s_j); if (unlikely(!__pyx_tuple__21)) __PYX_ERR(0, 18, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__21);
  __Pyx_GIVEREF(__pyx_tuple__21);
  __pyx_codeobj__22 = (PyObject*)__Pyx_PyCode_New(4, 0, 6, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__21, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_sklearn_utils__logistic_sigmoid, __pyx_n_s_log_logistic_sigmoid, 18, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__22)) __PYX_ERR(0, 18, __pyx_L1_error)
...
if (!__Pyx_RefNanny) {
  ...
  /* "sklearn/utils/_logistic_sigmoid.pyx":3
 ...
 *                           DTYPE_t[:, :] X,
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_7sklearn_5utils_17_logistic_sigmoid_1_log_logistic_sigmoid, NULL, __pyx_n_s_sklearn_utils__logistic_sigmoid_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 18, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_log_logistic_sigmoid, __pyx_t_1) < 0) __PYX_ERR(0, 18, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
