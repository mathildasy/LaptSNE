...
Original file is located at
    https://colab.research.google.com/drive/1uYU7xKpuEOd8CGVWn6VDuA1OmThL_SPQ
"""
...
def categorical_scatter_2d(X2D, class_idxs, title, ms=3, ax=None, alpha=0.1, legend=True, figsize=None, show=True, savename=None,filenames = None):
...
def estimate_sne(X, y, P, num_iters, q_fn, grad_fn, eigen_fn, learning_rate1, momentum, beta, num_eigen, plot,
    ...
    for i in tqdm(range(num_iters)):
        ...
        if i < num_iters - lst_stage:
            ...
            beta2 = beta
            print('beta =', beta)
            plots = categorical_scatter_2d(Y, y,
                                   ...
                                   alpha=1.0, ms=6,
                                   show=True, figsize=(9, 6),savename = f'{i}.png',filenames = filenames)
        ...
        #                            alpha=1.0, ms=6,
        #                            show=True, figsize=(9, 6),savename = i)
    categorical_scatter_2d(Y, y,
                           ...
                           alpha=1.0, ms=6,
                           show=True, figsize=(9, 6),filenames = filenames)
    return Y, lam_list,filenames
...
# Fit SNE or t-SNE
Y, lam_list, filenames = estimate_sne(X, y, P,
  num_iters=NUM_ITERS,
  q_fn= q_tsne if TSNE else q_joint,
  grad_fn= tsne_grad if TSNE_grad else yy_grad,
  eigen_fn= gk_grad if GK else eigen_grad,
