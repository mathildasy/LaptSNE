...
def eigen_grad(H, Q, Y, inv_distances, beta, rho):
...
def tsne_grad(P, Q, Y, inv_distances, H, beta = 0, rho = 0):
    """
    ...
    if beta != 0: 
        grad_Y2, grad_H = eigen_grad(H, Q, Y, inv_distances, beta, rho)
...
def estimate_sne(X, y, P, num_iters, q_fn, grad_fn, learning_rate1, learning_rate2,momentum, beta, rho, plot):
    ...
    for i in tqdm(range(num_iters)):
        ...
        grads_Y, grads_H = grad_fn(P, Q, Y, distances, H, beta, rho)
